...
Testing data difference engine for mosh basic data structures
...
- [_createModelCommands](README.md#moshDiff__createModelCommands)
- [addedObjects](README.md#moshDiff_addedObjects)
- [commonObjects](README.md#moshDiff_commonObjects)
- [compareFiles](README.md#moshDiff_compareFiles)
- [findObjects](README.md#moshDiff_findObjects)
- [missingObjects](README.md#moshDiff_missingObjects)
- [objectDiff](README.md#moshDiff_objectDiff)
- [restackOps](README.md#moshDiff_restackOps)
...
### <a name="moshDiff__createModelCommands"></a>moshDiff::_createModelCommands(obj, parentObj, intoList)
...
### <a name="moshDiff_addedObjects"></a>moshDiff::addedObjects(t)
...
### <a name="moshDiff_commonObjects"></a>moshDiff::commonObjects(t)
...
### <a name="moshDiff_compareFiles"></a>moshDiff::compareFiles(data1, data2)
...
### <a name="moshDiff_findObjects"></a>moshDiff::findObjects(data, saveTo, parentObj)
...
### moshDiff::constructor( t )

```javascript

```
        
### <a name="moshDiff_missingObjects"></a>moshDiff::missingObjects(t)
...
### <a name="moshDiff_objectDiff"></a>moshDiff::objectDiff(obj1, obj2)
...
### <a name="moshDiff_restackOps"></a>moshDiff::restackOps(input)
